# LOVE METER NEO v0.3.1 — Event Refined Build

## v0.3.1 のイベント向け変更（2026-08-28）

- `QUESTION_BANK_EVENT_V3` として EVENT_V2 に **恋人** を追加し、初対面・友達・親子・兄弟姉妹・夫婦と合わせて **6カテゴリ / 54問** にしました。
- こどもサポート機能を削除しました。イベントは通常表示へ一本化しています。
- EVENT用・子ども用アンケートを削除しました。**イベントモードではアンケートを実施しません。**
...
詳細は `CHANGELOG_v0.3.1.md` を参照してください。
